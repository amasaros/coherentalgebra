...
\begin{Example}
\\[1ex]As an integer, $5$ is a factor of $30$ because $30=5\cdot\makeblanksmall$.
\\[1ex]As a monomial, $3x^2$ is a factor of $9x^3y$ because $9x^3y=(3x^2)(\makeblanksmall)$.
\\[1ex]As a polynomial, $4x+3$ is a factor of $4x^2+3x$ because $4x^2+3x=(\makeblanksmall)(4x+3)$.
\end{Example}
