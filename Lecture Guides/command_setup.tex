...
%\mdfsetup{%
%%	roundcorner=0.5\linespace%
%%	innerleftmargin=.25in,
%%	innerrightmargin=.25in,
%%	innertopmargin=.25in,
%%	innerbottommargin=.25in,
	%linewidth=0.4pt,
	%frametitlerule=true,
...
%%%%%%
% Build these to mimic old mdframed
%\newenvironment{mdframed}[1][]{\begin{flushleft}\textbf{#1}\\[1ex]}{\end{flushleft}}
%\newenvironment{mdtitle}[2][]{\begin{mdframed}[#2: #1]}{\end{mdframed}}
\usetikzlibrary{shapes.multipart}
\newlength{\textht}
\setlength{\textht}{\heightof{ABC}}
\newcommand{\mytext}{}
\NewDocumentEnvironment{mdframed}{o +b}{%
\IfValueTF{#1}{%
\renewcommand{\mytext}{#1\\#2}%
}{%
\renewcommand{\mytext}{#2}%
}%
\begin{flushleft}%
\begin{tikzpicture}[MyRect/.style={rectangle split, rectangle split parts=2, draw, inner xsep=10pt, inner ysep=5pt, outer sep=0pt, anchor=base west}]%
\IfValueTF{#1}{
\draw (0,0) node[MyRect=2] {
	\begin{minipage}{\textwidth-20.8pt}\rule{0pt}{\textht}\end{minipage}
%	\begin{minipage}{\textwidth-20.8pt}\textbf{#1}\end{minipage}
	\nodepart{two}
	\begin{minipage}{\textwidth-20.8pt}#2\end{minipage}
};
\draw (10pt,0pt) node[anchor=base west,inner xsep=0pt, inner ysep=0pt, outer sep=0pt]{
	\begin{minipage}{\textwidth-20.8pt}\textbf{#1}\end{minipage}
};
}{
\draw (0,0) node[MyRect=1] {
	\begin{minipage}{\textwidth-20.8pt}#2\end{minipage}
};
}
\end{tikzpicture}
%\IfValueTF{#1}{\textbf{#1}\\[1ex]}{}%
%#2%
\end{flushleft}%
}{}
...
%\newenvironment{procedure}[1]{\begin{proc*}[#1]}{\end{proc*}}
...
\newenvironment{fact}[1][]{\begin{mdframed}[#1]}{\end{mdframed}}
