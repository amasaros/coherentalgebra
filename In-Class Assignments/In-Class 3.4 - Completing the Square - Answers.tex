...
\begin{smenum}
\mitemxx
{\CS{+8}[16][4]\CSsquare[4][16]}
{\CS{-4}[4][(-2)]\CSsquare[-2][4]}
\mitemxx
{\CS{-7}[\frac{49}{4}][\frac{7}{2}]\CSsquare[\frac{7}{2}][\frac{49}{4}]}
{\CS{+\frac{7}{5}}[\frac{49}{100}][\frac{7}{10}]\CSsquare[\frac{7}{10}][\frac{49}{100}]}
\end{smenum}
