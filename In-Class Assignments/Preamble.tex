...
\newcommand{\tquad}{\rule{1em}{0pt}}
\newcommand{\tqquad}{\rule{2em}{0pt}}
...
\begin{tikzpicture}[x=1ex,y=1ex,alt={A pentagon}]%
...
=%
\IfValueTF{#3}{\left(x+#3\right)^2}{\left(\rule{0pt}{3ex}x+\qquad\right)^2}$%
}
